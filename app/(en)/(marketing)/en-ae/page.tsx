...
const path = '/en-ae';
const seoTitle = 'Fleet Management Software in the UAE';
...
export const metadata: Metadata = buildCountryMetadata({ title: seoTitle, description: data.intro, path, language: 'en', alternatePath: '/ar-ae', alternateLanguage: 'ar' });

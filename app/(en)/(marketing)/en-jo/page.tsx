...
const path = '/en-jo';
const seoTitle = 'Fleet Management Software in Jordan';
...
export const metadata: Metadata = buildCountryMetadata({ title: seoTitle, description: data.intro, path, language: 'en', alternatePath: '/ar-jo', alternateLanguage: 'ar' });

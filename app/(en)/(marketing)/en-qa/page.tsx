...
const path = '/en-qa';
const seoTitle = 'Fleet Management Software in Qatar';
...
export const metadata: Metadata = buildCountryMetadata({ title: seoTitle, description: data.intro, path, language: 'en', alternatePath: '/ar-qa', alternateLanguage: 'ar' });

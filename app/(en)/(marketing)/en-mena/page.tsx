...
const path = '/en-mena';
const seoTitle = 'Fleet & Asset Management Software for MENA';
...
export const metadata: Metadata = buildCountryMetadata({ title: seoTitle, description: data.intro, path, language: 'en', alternatePath: '/ar-mena', alternateLanguage: 'ar' });

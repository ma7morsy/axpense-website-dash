...
const path = '/en-eg';
const seoTitle = 'Fleet Management Software in Egypt';
...
export const metadata: Metadata = buildCountryMetadata({ title: seoTitle, description: data.intro, path, language: 'en', alternatePath: '/ar-eg', alternateLanguage: 'ar' });

...
const market = getMarket('iq')!;
const data = market.ar;
const path = '/ar-iq';
const seoTitle = 'برنامج إدارة الأسطول في العراق';
...
export const metadata: Metadata = buildCountryMetadata({ title: seoTitle, description: data.intro, path, language: 'ar', alternatePath: '/en-iq', alternateLanguage: 'en' });

...
const market = getMarket('eg')!;
const data = market.ar;
const path = '/ar-eg';
const seoTitle = 'برنامج إدارة الأسطول في مصر';
...
export const metadata: Metadata = buildCountryMetadata({ title: seoTitle, description: data.intro, path, language: 'ar', alternatePath: '/en-eg', alternateLanguage: 'en' });

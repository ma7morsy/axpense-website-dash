...
const path = '/ar-sa';
const seoTitle = 'برنامج إدارة الأسطول في السعودية';
...
export const metadata: Metadata = buildCountryMetadata({ title: seoTitle, description: data.intro, path, language: 'ar', alternatePath: '/en-sa', alternateLanguage: 'en' });

...
const market = getMarket('qa')!;
const data = market.ar;
const path = '/ar-qa';
const seoTitle = 'برنامج إدارة الأسطول في قطر';
...
export const metadata: Metadata = buildCountryMetadata({ title: seoTitle, description: data.intro, path, language: 'ar', alternatePath: '/en-qa', alternateLanguage: 'en' });

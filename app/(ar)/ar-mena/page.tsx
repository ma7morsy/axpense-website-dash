...
const market = getMarket('mena')!;
const data = market.ar;
const path = '/ar-mena';
const seoTitle = 'برنامج إدارة الأسطول والأصول في MENA';
...
const relatedMarkets = [
  ...
  { label: 'الأردن', href: '/ar-jo' },
  { label: 'العراق', href: '/ar-iq' },
];

export const metadata: Metadata = buildCountryMetadata({ title: seoTitle, description: data.intro, path, language: 'ar', alternatePath: '/en-mena', alternateLanguage: 'en' });

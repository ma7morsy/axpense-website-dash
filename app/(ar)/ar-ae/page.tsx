...
const market = getMarket('ae')!;
const data = market.ar;
const path = '/ar-ae';
const seoTitle = 'برنامج إدارة الأسطول في الإمارات';
...
export const metadata: Metadata = buildCountryMetadata({ title: seoTitle, description: data.intro, path, language: 'ar', alternatePath: '/en-ae', alternateLanguage: 'en' });
